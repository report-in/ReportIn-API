...
import { createReport, deleteReport, exportExcelReport, updateReport, updateReportStatus, upvoteReport } from '../controllers/report.controller';
...
ReportRouter.post('/upvote', upvoteReport);